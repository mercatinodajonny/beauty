...
function ClExplore({nav,user,feed=FEED,setFeed}) {
        ...
        <div style={{padding:"50px 14px 10px"}}>
          <div style={{display:"flex",alignItems:"center",gap:9}}>
            ...
            {searchMode ? (
              ...
              <button onClick={()=>setShowCompose(true)} aria-label="Nuovo post" className="clay-btn" style={{flexShrink:0,width:38,height:38,borderRadius:12,border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",background:`linear-gradient(135deg,#FBA94C,${T.brand})`,color:T.white,fontFamily:"inherit"}}><IPlus/></button>
            )}
          </div>
          {!searchMode && (
...
export default function App() {
  ...
  const render = () => {
    ...
    if(screen==="cl_explore")    return <ClExplore nav={nav} user={user} feed={feed} setFeed={setFeed}/>;
