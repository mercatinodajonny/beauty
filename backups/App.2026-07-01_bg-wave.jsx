  ...
  s.textContent = `
    *{box-sizing:border-box;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent}
    ...
    .bg-alive::before, .bg-alive::after{
      ...
      width:100vw; height:100vw; max-width:760px; max-height:760px;
      filter:blur(60px); pointer-events:none; z-index:0;
      will-change:transform,opacity;
    }
    /* Onda rosa — si muove su e giù attraversando lo schermo */
    .bg-alive::before{
      top:-25%; left:-10%;
      background:radial-gradient(circle, rgba(255,122,200,0.60), rgba(255,122,200,0) 68%);
      animation:blobPink 18s ease-in-out infinite;
    }
    /* Onda blu — movimento opposto */
    .bg-alive::after{
      bottom:-25%; right:-10%;
      background:radial-gradient(circle, rgba(91,124,255,0.60), rgba(91,124,255,0) 68%);
      animation:blobBlue 21s ease-in-out infinite;
    }
    /* Il contenuto della home sopra le onde */
    .bg-alive > *{ position:relative; z-index:1; }
    @keyframes blobPink{
      0%  {transform:translate(-5vw,-10vh) scale(1);   opacity:.85;}
      50% {transform:translate(15vw,55vh) scale(1.25); opacity:1;}
      100%{transform:translate(-5vw,-10vh) scale(1);   opacity:.85;}
    }
    @keyframes blobBlue{
      0%  {transform:translate(5vw,10vh) scale(1);      opacity:.85;}
      50% {transform:translate(-15vw,-55vh) scale(1.3); opacity:1;}
      100%{transform:translate(5vw,10vh) scale(1);      opacity:.85;}
    }
