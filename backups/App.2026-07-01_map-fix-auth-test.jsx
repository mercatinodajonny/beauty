  ...
  if (view==="welcome") return wrap(
    <div className="ba-fade" style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",paddingBottom:20}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:11}}>
        {/* Accedi con Apple → scelta ruolo */}
        <button onClick={()=>setView("role")} style={{width:"100%",padding:"15px 0",borderRadius:14,border:"none",background:"#000000",color:"#fff",fontSize:16,fontWeight:600,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:9}}>
        ...
        {/* Accedi con Google → scelta ruolo */}
        <button onClick={()=>setView("role")} className="btn-apple" style={{width:"100%",padding:"15px 0",borderRadius:14,border:"1.5px solid #E5E5EA",background:"rgba(255,255,255,.9)",color:"#111111",fontSize:16,fontWeight:600,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:9}}>
        ...
        {/* Registrati con email → scelta ruolo */}
        <button onClick={()=>setView("role")} className="btn-apple" style={{width:"100%",padding:"15px 0",borderRadius:14,border:"1.5px solid #E5E5EA",background:"rgba(255,255,255,.9)",color:"#111111",fontSize:16,fontWeight:600,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:9}}>
  ...
  if (view==="role") {
    ...
    return wrap(
      <div className="ba-fade" style={{flex:1,display:"flex",flexDirection:"column",paddingTop:70}}>
        ...
        <div style={{flex:1}}/>
        <button disabled={!role} onClick={()=>setView(role==="pro"?"business":"clientForm")} style={{width:"100%",padding:"16px 0",borderRadius:14,border:"none",marginBottom:30,background:role?"#111111":"#EDEDED",color:role?"#fff":"#B0B0B0",fontSize:16,fontWeight:700,cursor:role?"pointer":"default",fontFamily:"inherit",transition:"all .2s"}}>
          Continua
        </button>
      </div>
    );
