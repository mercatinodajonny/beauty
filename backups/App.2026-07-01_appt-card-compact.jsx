        ...
        <div style={{padding:"20px 20px 0"}}>
          <div onClick={()=>nav("cl_appts")} className="ba-lift" style={{borderRadius:24,cursor:"pointer",background:"#FFFFFF",overflow:"hidden",boxShadow:`0 8px 30px ${T.brand}14, 0 2px 8px rgba(0,0,0,.04)`,position:"relative",transition:"transform .18s cubic-bezier(.34,1.56,.64,1),box-shadow .18s ease"}}>
            ...
            <div style={{padding:"12px 16px 14px"}}>
              <button onClick={e=>{e.stopPropagation();nav("cl_appts");}} style={{width:"100%",padding:"11px 0",borderRadius:14,border:"none",background:T.brand,color:"#fff",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit",letterSpacing:.2,boxShadow:`0 4px 14px ${T.brand}33`}}>
          ...
          {!selCat && (
            <>
                    ...
                    {myPros.slice(0,10).map(pro=>{
                      ...
                      return (
                        <div key={pro.id} onClick={()=>nav("cl_pro",pro)} style={{flexShrink:0,width:150,borderRadius:20,background:"#FFFFFF",boxShadow:"0 4px 20px rgba(0,0,0,.07)",cursor:"pointer",overflow:"hidden",padding:14,display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center"}}>
                          ...
                          <button onClick={e=>{e.stopPropagation();nav("cl_prenota",{pro});}} style={{width:"100%",padding:"9px 0",borderRadius:12,border:"none",background:T.brand,color:"#fff",fontSize:12.5,fontWeight:800,cursor:"pointer",fontFamily:"inherit",boxShadow:`0 3px 10px ${T.brand}44`}}>Prenota</button>
                        </div>
                      );
                    })}
                  </div>
              ...
              {rebookPros.length>0 && (
                <div style={{marginTop:24}}>
                  <div style={{padding:"0 20px",marginBottom:14}}>
                    <p style={{fontSize:18,fontWeight:900,color:"#0D0D0E",margin:0,letterSpacing:"-.04em"}}>Prenota di nuovo 🔁</p>
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:10,padding:"0 20px"}}>
                    {rebookPros.slice(0,4).map(pro=>{
                      ...
                      return (
                        <div key={pro.id} onClick={()=>nav("cl_pro",pro)} style={{display:"flex",alignItems:"center",gap:13,padding:"12px 14px",borderRadius:18,background:"#FFFFFF",boxShadow:"0 2px 14px rgba(0,0,0,.06)",cursor:"pointer"}}>
                          <div style={{width:52,height:52,borderRadius:14,overflow:"hidden",background:"#F5F5F5",flexShrink:0}}>
                            {photoUrl ? <img src={photoUrl} alt={pro.name} style={{width:"100%",height:"100%",objectFit:"cover"}} onError={e=>{e.currentTarget.style.display="none";}}/> : <div style={{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24}}>{pro.emoji}</div>}
                          </div>
                          <div style={{flex:1,minWidth:0}}>
                            <p style={{fontSize:14.5,fontWeight:800,color:"#0D0D0E",margin:"0 0 2px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{pro.name}</p>
                          ...
                          <button onClick={e=>{e.stopPropagation();nav("cl_prenota",{pro});}} style={{padding:"10px 18px",borderRadius:999,border:"none",background:T.brand,color:"#fff",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit",flexShrink:0,boxShadow:`0 3px 10px ${T.brand}44`}}>Ripeti</button>
                        </div>
                      );
                    })}
                  </div>
              ...
              <div style={{marginTop:24,paddingBottom:12}}>
                <div style={{padding:"0 20px",marginBottom:14,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  <p style={{fontSize:18,fontWeight:900,color:"#0D0D0E",margin:0,letterSpacing:"-.04em"}}>Disponibile oggi 🟢</p>
                  <button onClick={()=>openCategory("altro")} style={{background:"none",border:"none",cursor:"pointer",fontSize:13,color:T.brand,fontWeight:700,fontFamily:"inherit",padding:0}}>Vedi tutti →</button>
                </div>
                <div style={{display:"flex",gap:12,overflowX:"auto",padding:"4px 20px 8px",WebkitOverflowScrolling:"touch",scrollbarWidth:"none"}}>
                  {availToday.map(pro=>{
                    ...
                    return (
                      <div key={pro.id} onClick={()=>nav("cl_pro",pro)} style={{flexShrink:0,width:158,borderRadius:20,background:"#FFFFFF",boxShadow:"0 4px 20px rgba(0,0,0,.07)",cursor:"pointer",overflow:"hidden"}}>
                        <div style={{height:96,background:"#F0F0F0",position:"relative",overflow:"hidden"}}>
                          ...
                          <div style={{position:"absolute",top:8,left:8,display:"flex",alignItems:"center",gap:4,background:"rgba(255,255,255,.96)",borderRadius:999,padding:"3px 9px"}}>
                            ...
                            <span style={{fontSize:9.5,fontWeight:800,color:"#0D0D0E"}}>Oggi</span>
                          </div>
                        </div>
                        <div style={{padding:"11px 13px 13px"}}>
                          <p style={{fontSize:13.5,fontWeight:800,color:"#0D0D0E",margin:"0 0 2px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{pro.name}</p>
