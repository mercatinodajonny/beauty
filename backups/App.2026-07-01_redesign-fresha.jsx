...
const injectFont = () => {
  ...
  s.textContent = `
    *{box-sizing:border-box;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent}
    ...
    /* ── Sfondo vivo Beauty — sfumature rosa/blu impercettibili, movimento lentissimo ── */
    @keyframes bgDrift{
    ...
    .bg-alive{
      background:
        radial-gradient(circle at 15% 12%, rgba(255,122,200,0.13), transparent 42%),
        radial-gradient(circle at 85% 88%, rgba(91,124,255,0.13), transparent 42%),
        #FAFAFA;
