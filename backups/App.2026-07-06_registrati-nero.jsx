  ...
  if (view==="landing") return wrap(
    <div className="ba-fade" style={{flex:1,display:"flex",flexDirection:"column"}}>
      ...
      <div style={{padding:"0 4px 40px"}}>
        <button onClick={()=>setView("role")} style={{width:"100%",padding:"18px 0",borderRadius:999,border:"none",cursor:"pointer",fontFamily:"inherit",fontSize:17,fontWeight:800,color:"#fff",background:"#111111",boxShadow:"0 8px 24px rgba(0,0,0,.20)",letterSpacing:.2}}>
          Registrati
        </button>
