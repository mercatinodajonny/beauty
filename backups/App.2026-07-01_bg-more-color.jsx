...
const injectFont = () => {
  ...
  s.textContent = `
    *{box-sizing:border-box;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent}
    ...
    /* Macchia rosa — sale/scende, colore più percepibile */
    .bg-alive::before{
      top:-12%; left:-18%;
      background:radial-gradient(circle, rgba(255,122,200,0.24), rgba(255,122,200,0) 70%);
      animation:blobPink 22s ease-in-out infinite;
    }
    /* Macchia blu — deriva opposta */
    .bg-alive::after{
      bottom:-12%; right:-18%;
      background:radial-gradient(circle, rgba(91,124,255,0.24), rgba(91,124,255,0) 70%);
