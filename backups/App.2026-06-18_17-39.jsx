      ...
      {view==="calendario" && (
        <div style={{padding:"12px 14px"}}>
          <div style={{display:"flex",gap:5,marginBottom:12}}>
            {CAL_DAYS.map(d => (
              <button key={d.label} onClick={()=>setSelCalDay(d)} className={selCalDay.label===d.label?"clay-btn":"clay-soft"} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",padding:"9px 2px",borderRadius:15,border:"none",background:selCalDay.label===d.label?`linear-gradient(135deg,#2DD4BF,${T.brand})`:T.white,cursor:"pointer",fontFamily:"inherit"}}>
    ...
    <div style={{paddingBottom:90,background:T.paper,minHeight:"100dvh"}}>
      <div style={{background:T.white,padding:"50px 18px 0",borderBottom:`1px solid ${T.line}`}}>
        <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14}}>
          <div style={{width:56,height:56,borderRadius:"50%",background:`linear-gradient(135deg,#2DD4BF,${T.brand})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,fontWeight:800,color:T.white,flexShrink:0,boxShadow:"inset 2px 2px 4px rgba(255,255,255,.35), inset -2px -3px 5px rgba(180,83,9,.35)"}}>{info.name[0]}</div>
          <div>
      ...
      <div style={{padding:"10px 14px",display:"flex",flexDirection:"column",gap:10}}>
        {list.map(c => (
          <div key={c.id} onClick={()=>nav("pro_cliente",c)} className="clay ba-lift" style={{background:T.white,borderRadius:20,padding:"13px 15px",display:"flex",alignItems:"center",gap:12,cursor:"pointer"}}>
            <div style={{width:44,height:44,borderRadius:"50%",background:`linear-gradient(135deg,#2DD4BF,${T.brand})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:800,color:T.white,flexShrink:0,boxShadow:"inset 2px 2px 4px rgba(255,255,255,.35), inset -2px -3px 5px rgba(180,83,9,.35)"}}>{c.name[0]}</div>
            <div style={{flex:1,minWidth:0}}>
    ...
    <div style={{paddingBottom:90,background:T.paper,minHeight:"100dvh"}}>
      <div style={{background:T.white,padding:"48px 16px 14px",borderBottom:`1px solid ${T.line}`}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:12,marginTop:10}}>
          <div style={{width:54,height:54,borderRadius:"50%",background:`linear-gradient(135deg,#2DD4BF,${T.brand})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,fontWeight:800,color:T.white,boxShadow:"inset 2px 2px 4px rgba(255,255,255,.35), inset -2px -3px 5px rgba(180,83,9,.35)"}}>{client.name[0]}</div>
