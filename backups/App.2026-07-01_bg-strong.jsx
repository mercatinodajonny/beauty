...
const injectFont = () => {
  ...
  s.textContent = `
    *{box-sizing:border-box;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent}
    ...
    /* ── Sfondo Beauty — bianco #FAFAFA con due macchie animate (rosa/blu) ── */
    .bg-alive{ background:#FAFAFA; position:relative; }
    .bg-alive::before, .bg-alive::after{
      content:""; position:fixed; border-radius:50%;
      width:80vw; height:80vw; max-width:560px; max-height:560px;
      filter:blur(70px); pointer-events:none; z-index:0;
      will-change:transform,opacity;
    }
    /* Macchia rosa — sale/scende, colore ben visibile */
    .bg-alive::before{
      top:-8%; left:-12%;
      background:radial-gradient(circle, rgba(255,122,200,0.45), rgba(255,122,200,0) 70%);
      animation:blobPink 22s ease-in-out infinite;
    }
    /* Macchia blu — deriva opposta */
    .bg-alive::after{
      bottom:-8%; right:-12%;
      background:radial-gradient(circle, rgba(91,124,255,0.45), rgba(91,124,255,0) 70%);
    ...
    @keyframes blobPink{
      ...
      15% {opacity:1;}
      50% {transform:translate(12vw,13vh) scale(1.2); opacity:1;}
      85% {opacity:.85;}
    ...
    @keyframes blobBlue{
      0%  {transform:translate(0,0) scale(1);          opacity:.7;}
      18% {opacity:1;}
      50% {transform:translate(-12vw,-11vh) scale(1.24); opacity:1;}
      82% {opacity:.9;}
      100%{transform:translate(0,0) scale(1);          opacity:.7;}
    }
